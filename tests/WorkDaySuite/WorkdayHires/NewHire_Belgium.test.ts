...
const excelFileName = 'Hires/testDataBelgium.xlsx';
  ...
  dataSet.forEach((data, index) => {
    ...
    test(`@Hire Employee - Test ${index + 1} `, async ({ page, context, login, home, hireEmployee, appCommon, proxy }) => {
      try {
        ...
        //Change/Update My Government IDs
        await hrInbxPage.clickInboxMyTaskAndSubmit("Change/Update My Government IDs");
        await capObj.checkForScreenErrors();
        await appCommon.SuccessEventHandle();
        await hrInbxPage.clickInboxMyTaskAndSubmit("Change/Update My Contact Information");
        await capObj.checkForScreenErrors();
        await appCommon.SuccessEventHandle();
        await hrInbxPage.clickInboxMyTaskAndSubmit("Change Display Language (Belgium):");
        await capObj.checkForScreenErrors();
        await appCommon.SuccessEventHandle();
