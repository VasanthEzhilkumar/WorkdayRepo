...
const excelFileName = 'Rehires/Workday_Rehire_Czhecia_Regression_PK17.xlsx';
        ...
        if (data.TestStatus !== "Passed") {
            ...
            test(`@Rehire Employee - Test ${index + 1} `, async ({ page, appCommon, context, login, home, hireEmployee, proxy }) => {
                try {
                    ...
                    await empInboxpage.clickInboxMyTaskAndSubmit("Please Add Your Dependents");
                    await captureErrors.checkForScreenErrors();
                    await appCommon.SuccessEventHandle();
                    ...
                    await empInboxpage.HealthcareProviderMealVoucherSubmit()
                    await appCommon.SuccessEventHandle();
                    await appCommon.MyTasks();
                    ...
                    await hrInbxPage.assignPayGroupSubmitPayroll(data.ProposedPayGroupFinal);
                    await capObj.checkForScreenErrors();
                    await appCommon.SuccessEventHandle();
